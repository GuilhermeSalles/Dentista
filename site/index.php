...
<body>
   ...
   <header class="header" id="header">
      <nav class="nav container">
         <a href="" class="nav__logo">
            <img src="assets/img/logonav.png" width="190px" height="190px" style="margin-top: -1rem;" alt="logo">
         </a>
         ...
         <div class="nav__menu" id="nav-menu">
            ...
            <!-- Close Button -->
            <div class="nav__close" style="color: hsl(194, 64%, 38%);" id="nav-close">
         ...
         <!-- Toggle Button -->
         <div class="nav__toggle" style="color: hsl(194, 64%, 38%);" id="nav-toggle">
   ...
   <main class="main">
         ...
         <div class="home__container container grid">
            <div class="home__content">
               <div class="home__data">
                  ...
                  <h3 class="home__education" style="color: #333333;">sem precisar pagar suas dividas?</h3>

                  <p class="home_description" style="color: #333333;">
      ...
      <!--==================== ABOUT ====================-->
      <section class="about section" style="background-image: url('assets/img/consultorio.jpg'); background-repeat: no-repeat; background-size: cover; ">
         <h2 class="section__title" style="margin-bottom: -1rem;">
            <span>Garanta seu resultado</span>
         </h2>
         <div class="about__container container grid" style="padding: 2rem; text-align: center;">
            ...
            <div class="about__image">
               <img src="assets/img/familia.png" alt="image" width="640px" height="940px">
            </div>
         </div>
      </section>
      ...
      <!--==================== AGENDA ====================-->
      <section class="about section" id="about" style="background-image: url('assets/img/consultorio.jpg'); background-repeat: no-repeat; background-size: cover; ">
            ...
            <div class="about__image">
               <svg class="about__blob" viewBox="0 0 550 592" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                     ...
                     <!-- Insert your profile (recommended size: 640 x 940) -->
                     <image class="about_img" id="imageBorder" width="640" height="940" href="assets/img/perfil2.png" />
                  </defs>
               </svg>
            </div>
         </div>
      ...
      <div class="footer__container container grid">
         <div>
            <h1 class="footer__title">
               <img src="assets/img/icon.png" width="150px" height="180px" alt="logo">
            </h1>
         </div>
         ...
         <span class="footer__copy">
            &#169; Copyright <a href="https://seudestrave.com.br/" style="color: purple; font-weight: bold;">Destrave</a>. All rights reserved
         </span>
